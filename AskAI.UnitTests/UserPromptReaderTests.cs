...
public class UserPromptReaderTests
{
    ...
    {
        // Arrange
        var parametersProvider = Substitute.For<IWorkingContextParameters>();
        ...
        var sut = BuildServices(x =>
                {
                    ...
                    x.AddScoped<IWorkingContextParameters, IWorkingContextParameters>(_ => parametersProvider);
                    return x;
                }
            )
        ...
        var sut = BuildServices(x =>
                {
                    ...
                    x.AddScoped<IWorkingContextParameters, IWorkingContextParameters>(x=>parametersProvider);
                    return x;
                }
            )
            .GetService<IUserPromptReader>();
